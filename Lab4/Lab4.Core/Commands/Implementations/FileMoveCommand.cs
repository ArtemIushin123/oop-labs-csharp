...
public class FileMoveCommand : ICommand
{
    ...
    public FileMoveCommand(FileSystemConnection connection, string sourcePath, string destinationPath)
    {
    ...
    public Task<CommandResult> ExecuteAsync()
    {
        ...
        try
        {
            _connection.FileSystem.Move(_sourcePath, _destinationPath);
            return Task.FromResult(CommandResult.Ok($"Moved '{_sourcePath}' to '{_destinationPath}'"));
        }
        catch (Exception ex)
        {
